  ...
  class DeckStage extends HTMLElement {
    ...
    _render() {
      ...
      overlay.innerHTML = `
        ...
        <button class="btn text-btn reset" type="button" aria-label="Reset to first slide" title="Reset (R)">Reset<span class="kbd">R</span></button>
        <span class="divider"></span>
        <button class="btn text-btn pdf" type="button" aria-label="Save as PDF" title="Save as PDF (Cmd/Ctrl+P)">PDF 저장<span class="kbd">P</span></button>
      `;

      overlay.querySelector('.prev').addEventListener('click', () => this._go(this._index - 1, 'click'));
      overlay.querySelector('.next').addEventListener('click', () => this._go(this._index + 1, 'click'));
      overlay.querySelector('.reset').addEventListener('click', () => this._go(0, 'click'));
      overlay.querySelector('.pdf').addEventListener('click', () => this._downloadPDF());
